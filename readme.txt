...
Software Install: 
1. node.js: download by node.js website 
2. Sass - install by running the comment: npm iinstall -g sass
3. Sass watch css file running by the commend: sass --watch sass/style.scss:css/style.css

How to modify the css:
Css control by the Sass/style.sass file. 
and the Sass will automatically update the change into the Css/style.css  

Reset file:
Reset file is control by the reset.sass file
to watch the reset file, run the commend: sass --watch sass/reset.scss:css/reset.css
...
https://stackoverflow.com/questions/22384934/how-to-change-svg-fill-color-when-used-as-base-64-background-image-data


Url:  https://video-editor-prototype-92e6b.web.app

Note for Myself: Aug 10 2020
Video - Hide JS code
---------------------
The video project javascript code has been hide by using Javascript obfuscator at: https://obfuscator.io/
To copy the source code below and into "obfuscator.io", which will convert the JS into un-know/un-read JS.

To modify it again, must copy this again and modify and convert it again.
